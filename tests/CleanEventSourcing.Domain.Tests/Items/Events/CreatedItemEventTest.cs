...
namespace CleanEventSourcing.Domain.Tests.Items.Events
{
    public class CreatedItemEventTest
    {
        ...
        public void Constructor_ShouldSetId()
        {
            ...
            CreatedItemEvent createdEvent = new CreatedItemEvent(id, this.fixture.Create<string>());
        ...
        public void Constructor_ShouldSetDescription()
        {
            ...
            CreatedItemEvent createdEvent = new CreatedItemEvent(this.fixture.Create<Guid>(), description);
